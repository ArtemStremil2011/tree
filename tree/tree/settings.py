...
SECRET_KEY = 'django-insecure-jb7clmy_$w57)ndhp004z)sw^-#*_nslrqxzcsxtz6cz05azjo'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Можно добавить глобальную папку шаблонов: [BASE_DIR / 'templates']
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # если будете использовать общую папку static
]
...
LOGIN_REDIRECT_URL = '/'  # или 'person_list'
LOGOUT_REDIRECT_URL = '/'
